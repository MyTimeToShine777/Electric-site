...
<<<<<<< HEAD
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 items-start mb-6">
          <div ref={contentLeftRef} className="space-y-4 sm:space-y-6 overflow-hidden">
=======
...
<<<<<<< HEAD
          <div ref={contentRightRef} className="grid gap-3 overflow-hidden" style={{ opacity: 1 }}>
            {valuePropositions.map((item, index) => (
              <Card
                key={item.title}
                className={`p-3 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 border-0 bg-gradient-to-r ${item.color} group`}
